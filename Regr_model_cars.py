...
image_sidebar = Image.open(os.path.join(Base_dir, "regLinearModel_-car_predictions/pic1.png"))
...
#top banner
image_banner = Image.open(os.path.join(Base_dir, "regLinearModel_-car_predictions/pic2.png"))
